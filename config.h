...
static Key keys[] = {
    ...
    { MODKEY|ControlMask,  XK_Up,     spawn, SHCMD("pamixer -i 1 && bash ~/.config/dwm/statusbar/statusbar.sh update vol && bash ~/.dwm/statusbar/packages/vol.sh notify") },                                           /* super ctrl up    | 音量加                 */
    { MODKEY|ControlMask,  XK_Down,   spawn, SHCMD("pamixer -d 1 && bash ~/.config/dwm/statusbar/statusbar.sh update vol && bash ~/.dwm/statusbar/packages/vol.sh notify") },                                           /* super ctrl down  | 音量减                 */
    { MODKEY|ShiftMask,    XK_a,      spawn, SHCMD("flameshot gui") },                                          /* super shift a    | 截图                   */
    { MODKEY|ControlMask,  XK_Left,   spawn, SHCMD("light -U 1 && bash ~/.config/dwm/statusbar/statusbar.sh update light && bash ~/.dwm/statusbar/packages/light.sh notify") },                                         /* super ctrl left  | 屏幕亮度减             */
    { MODKEY|ControlMask,  XK_Right,  spawn, SHCMD("light -A 1 && bash ~/.config/dwm/statusbar/statusbar.sh update light && bash ~/.dwm/statusbar/packages/light.sh notify") },                                         /* super ctrl right | 屏幕亮度加             */
