...
static const Rule rules[] = {
    ...
    { NULL,                 "qq",                  NULL,             0,            0,          0,          0,        -1,      0}, // qq         
    { NULL,                 "wechat.exe",          NULL,             0,            0,          0,          0,        -1,      0}, // wechat     
    { NULL,                 "wxwork.exe",          NULL,             0,            0,          0,          0,        -1,      0}, // workwechat tag ->  无边框
...
static Key keys[] = {
    ...
    { MODKEY,              XK_d,      spawn, SHCMD("~/.config/dwm/config/rofi.sh") },                                  /* super d          | rofi: 执行run          */
    { MODKEY|ControlMask,  XK_Up,     spawn, SHCMD("pamixer -i 1 && bash ~/.config/dwm/statusbar/statusbar.sh update vol && bash ~/.config/dwm/statusbar/packages/vol.sh notify") },                                           /* super ctrl up    | 音量加                 */
    { MODKEY|ControlMask,  XK_Down,   spawn, SHCMD("pamixer -d 1 && bash ~/.config/dwm/statusbar/statusbar.sh update vol && bash ~/.config/dwm/statusbar/packages/vol.sh notify") },                                           /* super ctrl down  | 音量减                 */
    { MODKEY|ShiftMask,    XK_a,      spawn, SHCMD("flameshot gui") },                                          /* super shift a    | 截图                   */
    { MODKEY|ControlMask,  XK_Left,   spawn, SHCMD("light -U 1 && bash ~/.config/dwm/statusbar/statusbar.sh update light && bash ~/.config/dwm/statusbar/packages/light.sh notify") },                                         /* super ctrl left  | 屏幕亮度减             */
    { MODKEY|ControlMask,  XK_Right,  spawn, SHCMD("light -A 1 && bash ~/.config/dwm/statusbar/statusbar.sh update light && bash ~/.config/dwm/statusbar/packages/light.sh notify") },                                         /* super ctrl right | 屏幕亮度加             */
    { MODKEY|ShiftMask,    XK_q,      spawn, SHCMD("kill -9 $(xprop | grep _NET_WM_PID | awk '{print $3}')") }, /* super shift q    | 选中某个窗口并强制kill */
    { MODKEY,              XK_Escape, spawn, SHCMD("bash ~/.config/dwm/config/settings.sh") },                         /* super esc        | 关机/重启              */
